...
* **AniList Tag Bypass:** A specialized search tool to discover top-rated Anime & Manga by tags, bypassing standard filter limitations.
...
| User Search Profile | Tag Bypass System | Manga Progress Dashboard |
|:-------------------:|:-----------------:|:------------------------:|
| ![Profile Page](screenshots/p1.png) | ![Tag Bypass](screenshots/p2.png) | ![Manga Page](screenshots/p3.png) |
...
2.  **Edit the ServiceProvider file**
    ...
    ```
    *(Note: This is only required for local development environment)*
